...
import static us.ihmc.javaFXToolkit.graphics.JavaFXMeshDataInterpreter.interpretMeshData;
...
public class MeshDataGeneratorVisualizer
{
   ...
   public MeshDataGeneratorVisualizer(Stage primaryStage)
   {
      ...
      MeshView arcTorus = new MeshView(interpretMeshData(MeshDataGenerator.ArcTorus(0.0, 1.0 * Math.PI, 0.15, 0.05, 64)));
      ...
      MeshView cylinder = new MeshView(interpretMeshData(MeshDataGenerator.Cylinder(0.1, 0.3, 64, true)));
      ...
      MeshView flatRectangle = new MeshView(interpretMeshData(MeshDataGenerator.FlatRectangle(0.2, 0.3, 0.0)));
      ...
      MeshView cone = new MeshView(interpretMeshData(MeshDataGenerator.Cone(0.3, 0.1, 64)));
      cone.setMaterial(defaultMaterial);
      cone.setTranslateX(0.0);
      cone.setTranslateY(-0.5);
      view3dFactory.addNodeToView(cone);

      MeshView wedge = new MeshView(interpretMeshData(MeshDataGenerator.Wedge(0.3, 0.2, 0.2)));
      wedge.setMaterial(defaultMaterial);
      wedge.setTranslateX(0.0);
      wedge.setTranslateY(-1.0);
      view3dFactory.addNodeToView(wedge);

      MeshView sphere = new MeshView(interpretMeshData(MeshDataGenerator.Ellipsoid(0.15, 0.05, 0.2, 64, 64)));
      ...
      MeshView extrudedPolygon = new MeshView(interpretMeshData(MeshDataGenerator.ExtrudedPolygon(polygonVertices, 0.1)));
      ...
      MeshView line = new MeshView(interpretMeshData(MeshDataGenerator.Line(0.0, 0.0, 0.2, 0.0, 0.5, 0.0, 0.01)));
      line.setMaterial(defaultMaterial);
      line.setTranslateX(0.5);
      line.setTranslateY(1.0);
      view3dFactory.addNodeToView(line);

      MeshView pyramidCube = new MeshView(interpretMeshData(MeshDataGenerator.PyramidBox(0.1, 0.2, 0.1, 0.25)));
      ...
      MeshView capsule = new MeshView(interpretMeshData(MeshDataGenerator.Capsule(0.2, 0.025, 0.05, 0.07, 16, 16)));
      capsule.setMaterial(defaultMaterial);
      capsule.setTranslateX(0.5);
      capsule.setTranslateY(-1.0);
      view3dFactory.addNodeToView(capsule);

      MeshView genTruncatedCone = new MeshView(interpretMeshData(MeshDataGenerator.TruncatedCone(0.25, 0.2, 0.07, 0.05, 0.1, 64, false)));
      ...
      MeshView hemiEllipsoid = new MeshView(interpretMeshData(MeshDataGenerator.HemiEllipsoid(0.10, 0.20, 0.2, 64, 64)));
      ...
      MeshView tetrahedron = new MeshView(interpretMeshData(MeshDataGenerator.Tetrahedron(0.3)));
      ...
      MeshView polygon = new MeshView(interpretMeshData(MeshDataGenerator.PolygonCounterClockwise(null, polygonVertices)));
      polygon.setMaterial(defaultMaterial);
      polygon.setTranslateX(-0.5);
      polygon.setTranslateY(-0.5);
      view3dFactory.addNodeToView(polygon);

      MeshView polytope = new MeshView(interpretMeshData(MeshDataGenerator.ConvexPolytope(EuclidPolytopeFactories.newIcosahedron(0.2))));
      ...
      MeshView cube = new MeshView(interpretMeshData(MeshDataGenerator.Box(0.1, 0.2, 0.3, true)));
      cube.setMaterial(defaultMaterial);
      cube.setTranslateX(1.0);
      cube.setTranslateY(0.0);
      view3dFactory.addNodeToView(cube);

      MeshView polygon3D = new MeshView(interpretMeshData(MeshDataGenerator.PolygonCounterClockwise(polygonVertices.stream().map(p2D ->
      {
      ...
      MeshView torus = new MeshView(interpretMeshData(MeshDataGenerator.Torus(0.15, 0.05, 64)));
