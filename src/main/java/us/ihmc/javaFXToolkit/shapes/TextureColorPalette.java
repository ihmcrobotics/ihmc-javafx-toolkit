 ...
 * usage is for {@link JavaFXMultiColorMeshBuilder} that re-maps texture coordinates of the mesh
 * vertices to point to the image of the active {@link TextureColorPalette} and to allow the user to
 * render a mesh with more than one color.
 * 
...
{
   /**
    * Retrieves the texture coordinates of a given {@link Color} in the image of this
    * {@link TextureColorPalette}.
    * 
   ...
   /**
    * Retrieves the texture coordinates of a given {@code (red, green, blue)} in the image of this
    * {@link TextureColorPalette}.
    * 
