...
/**
 * This class provides simple tools for setting up JavaFX UI control label formatter such as
 * {@link Slider#setLabelFormatter(StringConverter)}.
 * 
...
{
   /**
    * @return a StringConverter that converts values expressed in meters to be displayed in
    *         centimeters.
    */
    ...
    * 
    * @param appendK whether to append the suffix 'k' after the displayed number or not, for instance:
    *                {@code 100000} will be displayed {@code 100k} when it is {@code true}.
    * @return reduce large-scale values to display only the thousands, for instance: {@code 100000}
    *         will be displayed {@code 100}.
    */
