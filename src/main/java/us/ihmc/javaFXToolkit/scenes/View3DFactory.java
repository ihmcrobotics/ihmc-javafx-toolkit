...
/**
 * This helper class allows the creation of a JavaFX {@link Scene} or {@link SubScene} setup for 3D
 * rendering. It gathers the common tools that are generally needed to do so, such as a camera
 * controller, lights, world coordinate system. At any time the {@link Scene} or {@link SubScene}
 * can be accessed and customized at will.
 * 
...
public class View3DFactory
{
   ...
   /**
    * Creates a factory that will create and setup a {@link Scene} with the depth buffer and
    * anti-aliasing defaulted to {@code true} and {@code BALANCED}, respectively.
    * 
   ...
   /**
    * Creates a factory that will create and setup a {@link Scene} with the anti-aliasing defaulted to
    * BALANCED.
    * 
    * @param width       the width of the scene in pixels.
    * @param height      the height of the scene in pixels.
    ...
    * @param height       the height of the scene in pixels.
    * @param depthBuffer  the depth buffer flag.
    * @param antiAliasing the scene anti-aliasing attribute. A value of {@code null} is treated as
    *                     DISABLED.
    * @param sceneType    the type of the scene to create, i.e. {@code MAIN_SCENE} for creating a
    *                     {@link Scene} or {@code SUB_SCENE} for creating a {@link SubScene}.
    */
   ...
   /**
    * @return a factory that will create and setup a {@link SubScene} with the depth buffer and
    *         anti-aliasing defaulted to {@code true} and {@code BALANCED}, respectively.
    */
    ...
    * Add a {@link PerspectiveCamera} with a default controller to the 3D view.
    * 
    * @param enableShiftClickFocusTranslation whether to use the quick focus translation with Shift +
    *                                         Mouse left click or not.
    * @return the camera controller.
    */
    ...
    * Add a {@link PerspectiveCamera} with a default controller to the 3D view.
    * 
    * @param nearClip                         specifies the distance from the eye of the near clipping
    *                                         plane of the {@code Camera} in the eye coordinate space.
    * @param farClip                          specifies the distance from the eye of the far clipping
    *                                         plane of the {@code Camera} in the eye coordinate space.
    * @param enableShiftClickFocusTranslation whether to use the quick focus translation with Shift +
    *                                         Mouse left click or not.
    * @return the camera controller.
   ...
   /**
    * Registers an event handler to the scene being created. The handler is called when the scene
   ...
   /**
    * <p>
    * Only available for sub-scene creation.
    * </p>
    * Wrap the sub-scene in a {@link Pane}, bind its size properties to the Pane, and returns it. It is
    * the preferred option when creating a UI with several elements.
    * 
    ...
    * Only available for sub-scene creation.
    * </p>
    * Adds the created sub-scene to the pane's children and binds the sub-scene size to the pane's
    * size.
    * 
